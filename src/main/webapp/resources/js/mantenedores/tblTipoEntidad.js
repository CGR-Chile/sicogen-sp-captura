...
$(document).ready(function () {
	...
	$('#ExpenseTableContainer').jtable({
		...
		messages: {
			...
			listAction: 'listTblTipoEntidad',
			createAction: 'addTblTipoEntidad',
			updateAction: 'updTblTipoEntidad',
			deleteAction: 'delTblTipoEntidad'
		},fields: {
...
function loadData(){
	$('#ExpenseTableContainer').click(function (e) {
		...
		$('#ExpenseTableContainer').jtable('load', {
			...
			TipoEntidad: $("#cbTipoEntidadC1 :selected").val(),
