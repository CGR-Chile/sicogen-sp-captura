...
function Ejercicio(){	$('#ExpenseTableContainer').jtable('load');	return false;} 
...
$(document).ready(function() {
    ...
    $('#ExpenseTableContainer').jtable({
		...
		messages: {
			...
			listAction: 'listTblEjercicio',
			createAction: 'addTblEjercicio',
			updateAction: 'updTblEjercicio',
			deleteAction: 'delTblEjercicio'
		},fields: {
