...
function grabarCabecera(informe){
	...
	if (pasa == true)
	{
		...
		if($("#monedaOrigen option:selected").val()==null || $("#monedaOrigen option:selected").val()=="" || $("#monedaOrigen option:selected").val()=="-1"){
	...
	var dv   =   $('#dv').val();
	var registros =   $('#Registros').val();
	var Pobligado   =   $('#debeRegistro').val();
	var ejercicio =   $('#ejercicio').val();
	var Obligado   =   $('#haberRegistro').val();
	var tdebito   =   $('#debeOrigen').val();
	var tcredito   =   $('#HaberOrigen').val();
	...
	var totalPreObligado = $('#saldoDebeRegistro').val();
...
function grabarDetalle(informe){
	...
	var aumento    = $('#debeRegistro').val(); 
	var disminucion = $('#haberRegistro').val(); 
	var debeOrigen    = $('#debeOrigen').val(); 
	var haberOrigen = $('#HaberOrigen').val(); 
	var saldodeudor    = $('#saldoDebeRegistro').val(); 
	var saldoacreedor= $('#saldoHaberRegistro').val(); 
	var saldodeudorOrigen    = $('#txtSaldoDeudorOrigen').val(); 
	var saldoacreedorOrigen= $('#txtSaldoAcreedorOrigen').val(); 
	...
	var moneda = $('#monedaOrigen option:selected').text();
	var rut   =   $('#rut').val();
	var dv   =   $('#dv').val();
	...
	+'&saldoDeudor='+ saldodeudor 
	+'&saldoAcreedor='+ saldoacreedor
	+'&saldodeudorOrigen='+ saldodeudorOrigen 
	+'&saldoacreedorOrigen='+ saldoacreedorOrigen
	+'&registros='+ registros
	...
	+'&debeOrigen='+ debeOrigen 
	+'&codigoCuenta='+ codigoCuenta 
	+'&haberOrigen='+ haberOrigen 
	+'&glosaPeriodo='+ glosaPeriodo;
...
function AddItem(informe, idhijo, idpadre, idpadreHijo) {
    ...
    Totales($('#debeRegistro').val(), $('#haberRegistro').val(), informe);
    contadorR(01);
    //introduce los valores a la lista de detalle
    var tr= "<tr id='line"+contador+"'>" +
				"<td><input id='lmuni" 		  + contador + "' disabled='true' class='txtFile' style='width:100px;'  type='text' value='" + $('#Denom').val() + "'></td>" +
				"<td><input id='ltitulo" 	  + contador + "' disabled='true' class='txtFile' style='width:45px;text-align: right;' type='text' value='" + $('#cbTitulo').val() + "'></td>" +
				"<td><input id='lgrupo" 	  + contador + "' disabled='true' class='txtFile' style='width:45px;text-align: right;' type='text' value='" + $('#cbGrupo').val() + "'></td>" +
				"<td><input id='lsubGrupo" 	  + contador + "' disabled='true' class='txtFile' style='width:45px;text-align: right;' type='text' value='" + $('#cbSubGrupo').val() + "'></td>" +
				...
				"<td><input id='lcuentaNivel2" + contador + "' disabled='true' class='txtFile' style='width:45px;text-align: right;' type='text' value='" + $('#cbNivel2').val() + "'></td>" +
				"<td><input id='lcuentaNivel3" + contador + "' disabled='true' class='txtFile' style='width:45px;text-align: right;' type='text' value='" + $('#cbNivel3').val() + "'></td>" +
				"<td><input id='lcuentaNivel4" + contador + "' disabled='true' class='txtFile' style='width:45px;text-align: right;' type='text' value='" + $('#cbNivel4').val() + "'></td>" +
				"<td><input id='lcuentaNivel5" + contador + "' disabled='true' class='txtFile' style='width:66px;' type='text' value='" + $('#cbNivel5').val() + "'></td>" +
				"<td><input id='ldebeRegistro" + contador + "' disabled='true' class='txtFile' style='width:66px;text-align: right;' type='text' value='" + $('#debeRegistro').val() + "'></td>" +
				"<td><input id='lhaberRegistro" + contador + "' disabled='true' class='txtFile' style='width:66px;text-align: right;' type='text' value='" + $('#haberRegistro').val() + "'></td>" +
				"<td><input id='lsaldoDebeRegistro" + contador + "' disabled='true' class='txtFile' style='width:66px;text-align: right;' type='text' value='" + $('#saldoDebeRegistro').val() + "'></td>" +
				"<td><input id='lsaldoHaberRegistro" + contador + "' disabled='true' class='txtFile' style='width:66px;text-align: right;' type='text' value='" + $('#saldoHaberRegistro').val() + "'></td>" +
				"<td><input id='lmoneda" + contador + "' disabled='true' class='txtFile' style='width:66px;' type='text' value='" +$('#monedaOrigen option:selected').text() + "'></td>" +
				"<td><input id='ldebeOrigen" + contador + "' disabled='true' class='txtFile' style='width:45px;text-align: right;' type='text' value='" + $('#debeOrigen').val() + "'></td>" +
				"<td><input id='lhaberOrigen" + contador + "' disabled='true' class='txtFile' style='width:45px;text-align: right;' type='text' value='" + $('#HaberOrigen').val() + "'></td>" +
				"<td><input id='lsaldoDebeOrigen" + contador + "' disabled='true' class='txtFile' style='width:66px;text-align: right;' type='text' value='" + $('#txtSaldoDeudorOrigen').val() + "'></td>" +
				"<td><input id='lsaldoHaberOrigen" + contador + "' disabled='true' class='txtFile' style='width:66px;text-align: right;' type='text' value='" + $('#txtSaldoAcreedorOrigen').val() + "'></td>" +
				"<td style='display:none;'><input id='ldistri"      + contador + "' disabled='true' class='txtFile' style='width:45px;' type='text' value='" + 1 + "'></td>" +
...
function cambiaCuenta4(subAnaSubCuenta){
	...
	$.ajax({url: action,
	    ...
	    error: function(data){
	    	$('#cbNivel5').empty();
	    	$("#cbNivel5").get(0).options[$("#cbNivel5").get(0).options.length] = new Option( '--',-1);
