...
public class AddImageExcel {
    ...
    public void addImageToSheet(int colNumber, int rowNumber, Sheet sheet, Drawing drawing,
        ...
        if((resizeBehaviour != AddImageExcel.EXPAND_COLUMN) &&
           (resizeBehaviour != AddImageExcel.EXPAND_ROW) &&
           (resizeBehaviour != AddImageExcel.EXPAND_ROW_AND_COLUMN) &&
           (resizeBehaviour != AddImageExcel.OVERLAY_ROW_AND_COLUMN)) {
    ...
    private ClientAnchorDetail fitImageToColumns(Sheet sheet, int colNumber,
        ...
        if(colWidthMM < reqImageWidthMM) {
            ...
            if((resizeBehaviour == AddImageExcel.EXPAND_COLUMN) ||
               (resizeBehaviour == AddImageExcel.EXPAND_ROW_AND_COLUMN)) {
                ...
                if(sheet instanceof HSSFSheet) {
                    ...
                    pictureWidthCoordinates = (int)reqImageWidthMM * AddImageExcel.EMU_PER_MM;
                }
            ...
            else if ((resizeBehaviour == AddImageExcel.OVERLAY_ROW_AND_COLUMN) ||
                     (resizeBehaviour == AddImageExcel.EXPAND_ROW)) {
    ...
    private ClientAnchorDetail fitImageToRows(Sheet sheet, int rowNumber,
        ...
        if(rowHeightMM < reqImageHeightMM) {
            if((resizeBehaviour == AddImageExcel.EXPAND_ROW) ||
               (resizeBehaviour == AddImageExcel.EXPAND_ROW_AND_COLUMN)) {
            ...
            // the image out ver one or more rows.
                    ...
                    (resizeBehaviour == AddImageExcel.EXPAND_COLUMN)) {
    ...
    private ClientAnchorDetail calculateColumnLocation(Sheet sheet,
        ...
        if((int)totalWidthMM == (int)reqImageWidthMM) {
            ...
            if(sheet instanceof HSSFSheet) {
                ...
                anchorDetail = new ClientAnchorDetail(startingColumn,
                    toColumn, (int)reqImageWidthMM * AddImageExcel.EMU_PER_MM);
            }
        }
        ...
        // for the ClientAnchorDetail object.
            ...
            if(sheet instanceof HSSFSheet) {
                ...
                inset = (int)overlapMM * AddImageExcel.EMU_PER_MM;
            }
    ...
    private ClientAnchorDetail calculateRowLocation(Sheet sheet,
        ...
        if((int)totalRowHeightMM == (int)reqImageHeightMM) {
            if(sheet instanceof HSSFSheet) {
                ...
                clientAnchorDetail = new ClientAnchorDetail(startingRow, toRow,
                    (int)reqImageHeightMM * AddImageExcel.EMU_PER_MM);
            }
        }
        else {
    ...
    public static void main(String[] args) {
        ...
        try {
        	...
        	sheet = workbook.createSheet("Picture Test");
               	imageFile = args[0];
        	outputFile = args[1];
        	new AddImageExcel().addImageToSheet("B5", sheet, sheet.createDrawingPatriarch(),
        		new File(imageFile).toURI().toURL(), 100, 40,
        		AddImageExcel.EXPAND_ROW_AND_COLUMN);
